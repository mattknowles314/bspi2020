...
vulcan_analysis <- function(){

  #This first section is a modified version of vulcan.import()
  ...
  vobj_analysis<-vulcan(vobj, network = network, minsize = 5, contrast = c("Non-Responder", "Metastasis"))
  ...
  save(vobj_analysis, file="/home/matthew/Documents/BSPIData/rdata/vobjanalysis.Rdata")
}

make_plots <- function() {
  png(file="~/Documents/BSPIData/plots/vulcdata.png")
